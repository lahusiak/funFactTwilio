...
//    func request(options: [String: Any], callback: ((err: NSError?, response: NSHTTPURLResponse?, body: AnyObject?)->())?) throws {
...
//        }
//        
//        let task = try session.dataTaskWithRequest(urlRequest, completionHandler: {body, response, err in
...
//                    var json: AnyObject! = NSJSONSerialization.JSONObjectWithData(body! as NSData, options: NSJSONReadingOptions.MutableContainers)
